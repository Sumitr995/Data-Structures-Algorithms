<h2><a href="https://leetcode.com/problems/snake-in-matrix/?envType=problem-list-v2&envId=array">3533. Snake in Matrix</a></h2><h3>Easy</h3><hr><p>There is a snake in an <code>n x n</code> matrix <code>grid</code> and can move in <strong>four possible directions</strong>. Each cell in the <code>grid</code> is identified by the position: <code>grid[i][j] = (i * n) + j</code>.</p>
